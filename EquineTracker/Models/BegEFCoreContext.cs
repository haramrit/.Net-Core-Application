...
namespace EquineTracker.Models
{
    ...
    {
        public BegEFCoreContext()
        {
        }

        public BegEFCoreContext(DbContextOptions<BegEFCoreContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Server=localhost;Database=BegEFCore; User ID=LAPTOP-D8C511R8\\SQLEXPRESS; Trusted_Connection=true;");
//            }
//        }
